    ...
    return (
         <section id="Pricing" className='text-zinc-950 text-center  m-0 p-0 box-border bg-[#f0f0f0] px-[0] py-[60px] block w-screen'>
            <div className='max-w-[1200px] mx-[auto] my-[0] px-[20px] py-[0] block'>
                ...
                <div className='[rotate:none]  opacity-100 max-w-[500px] ml-[auto] mr-[auto] my-[40px] border-[5px] border-[solid] border-[white] rounded-[24px] p-[40px] [box-shadow:0_10px_30px_black] block bg-yellow-50 '>
