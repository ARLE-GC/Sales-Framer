  ...
  return (
    <section className='text-zinc-950 flex items-center justify-between gap-8 flex-wrap text-center px-[0] py-[60px] m-0 p-0 box-border  w-screen bg-yellow-100'>
        <div className='max-w-[1200px] mx-[auto] my-[0] px-[20px] py-[0] block'>
            <div className='  inline-flex justify-center items-center gap-[15px] bg-[white] border-[2px] border-[solid] border-[black] px-[15px] py-[8px] rounded-[50px] ml-[auto] mr-[auto] my-[0] [box-shadow:0_4px_0_black] animate__animated animate__rotateInDownLeft'>
            <div className='flex'>
            ...
            <h1 className='[rotate:none] opacity-100  text-[40px] text-[black] mb-[20px] uppercase text-center leading-[1.2] block font-bold animate__animated animate__fadeInUp'>La prospection <br/> LinkedIn automatisée <br/> 
            <span className='px-[15px] py-[0]  inline-block bg-yellow-300'>pour 9,99€/mois</span></h1>

            <p className='[rotate:none] opacity-100  text-[18px] mt-[20px] mb-[15px] block animate__animated animate__fadeInUp'>
