...
const Hero = () => {
  return (
    <section className='text-zinc-950 flex items-center justify-between gap-8 flex-wrap text-center px-[0] py-[60px] m-0 p-0 box-border block w-screen bg-yellow-100'>
        <div className='max-w-[1200px] mx-[auto] my-[0] px-[20px] py-[0] block'>
            ...
            <h1 className='[rotate:none] opacity-100 translate-x-0 translate-y-0 text-[40px] text-[black] mb-[20px] uppercase text-center leading-[1.2] block font-bold'>La prospection <br/> LinkedIn automatisée <br/> 
            <span className='px-[15px] py-[0] -rotate-1 inline-block bg-yellow-300'>pour 9,99€/mois</span></h1>

            <p className='[rotate:none] opacity-100 translate-x-0 translate-y-0 text-[18px] mt-[20px] mb-[15px] block'>
