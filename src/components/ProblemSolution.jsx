        ...
        <section className='text-center text-zinc-950 px-[0] py-[60px] block m-0 p-0 box-border w-screen'>
            <div className='max-w-[1200px] mx-[auto] my-[0] px-[20px] py-[0] block'>
                ...
                <div className='flex justify-center gap-[30px] mt-[40px] flex-col lg:flex-row lg:items-center space-y8 p-2 items-center'>
                    <div className='[rotate:none]  opacity-100 w-full max-w-[450px] bg-[white] rounded-[20px] p-[30px] text-left border-[3px] border-[solid] border-[black] [box-shadow:8px_8px_0_black] block animate__animated animate__rotateInDownLeft'>
                    ...
                    <div className='[rotate:none]   w-full max-w-[450px] bg-[white] rounded-[20px] p-[30px] text-left border-[3px] border-[solid] border-[black] [box-shadow:8px_8px_0_black] block animate__animated animate__rotateInDownRight'>
